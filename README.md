# ⚽ Football Rankings System – Task Description
...
iv. Should have following scoring: win – 3 points, draw – 1 points and loss: 0 points
...
**Deliverable:**  
Provide the full solution (including `.sln` and all projects) in a Git repository or other downloadable format so it can be cloned, started, and tested directly.
